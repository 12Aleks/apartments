...
INSERT INTO "new_PropertyLocation" ("city", "id", "landmark", "lat", "lng", "propertyId", "region", "state", "streetAddress", "zip") SELECT "city", "id", "landmark", "lat", "lng", "propertyId", "region", "state", "streetAddress", "zip" FROM "PropertyLocation";
