...
INSERT INTO "new_Property" ("createAt", "description", "id", "name", "price", "statusId", "typeId", "updateAt", "userId") SELECT "createAt", "description", "id", "name", "price", "statusId", "typeId", "updateAt", "userId" FROM "Property";
DROP TABLE "Property";
